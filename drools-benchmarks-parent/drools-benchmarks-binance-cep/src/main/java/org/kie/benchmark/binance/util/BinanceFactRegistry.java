 ...
 * produced
 * (inserted or updated) each fact, for use by
 * {@link BinanceCausalTraceListener}.
 *
 * <p>
 ...
 * {@link AtomicLong}.
 */
public class BinanceFactRegistry {
     ...
     * before.
     * Uses {@link System#identityHashCode} as the key — stable for the object
     * lifetime.
     */

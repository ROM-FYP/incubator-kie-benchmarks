...
/**
 * JMH runner for the RIPE RIS CEP sequential baseline architecture.
 */
...
public class RipeRisSequentialJmhRunner {
    ...
    public void setupTrial() throws Exception {
        ...
        config.setOption(ParallelExecutionOption.SEQUENTIAL);
    ...
    public void teardownInvocation() {
        ...
        System.out.printf(
                "[Sequential Invocation %d] Events: %d | Rules fired: %,d | Duration: %d ms | Throughput: %.2f events/sec | Peak Heap: %d MB%n",
    ...
    public void teardownTrial() {
        ...
        System.out.println("\n=== Sequential Trial Summary (Measurement Iterations) ===");
        ...
        writeResultsJson("sequential", avgTime, avgThroughput, avgPeakHeap, startIndex, warmupIters);
    }
    ...
    public static void main(String[] args) throws Exception {
        Options opt = new OptionsBuilder()
                .include(RipeRisSequentialJmhRunner.class.getSimpleName())
                .build();
        new Runner(opt).run();
    }
}

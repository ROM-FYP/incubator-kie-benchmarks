...
public class BgpUpdateFact implements Serializable {
    ...
    public BgpUpdateFact() {
    }

    public BgpUpdateFact(String messageId, String peer, String peerAsn, String host, double timestamp, List<?> path, List<?> community, String origin, Integer med, Object aggregator, List<?> announcements, List<?> withdrawals) {

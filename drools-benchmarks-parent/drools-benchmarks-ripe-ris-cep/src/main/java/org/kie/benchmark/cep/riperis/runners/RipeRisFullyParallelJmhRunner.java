...
/**
 * JMH runner for the RIPE RIS CEP built-in fully parallel architecture.
 */
...
public class RipeRisFullyParallelJmhRunner {
    ...
    public void setupTrial() throws Exception {
        System.out.println("\n=== RIPE RIS Fully Parallel JMH Setup ===");
    ...
    @Benchmark
    public long fullyParallelReplay() {
    ...
    public void teardownInvocation() {
        ...
        System.out.printf(
                "[FullyParallel Invocation %d] Events: %d | Rules fired: %,d | Duration: %d ms | Throughput: %.2f events/sec | Peak Heap: %d MB%n",
    ...
    public void teardownTrial() {
        ...
        System.out.println("\n=== Fully Parallel Trial Summary (Measurement Iterations) ===");
    ...
    public static void main(String[] args) throws Exception {
        Options opt = new OptionsBuilder()
                .include(RipeRisFullyParallelJmhRunner.class.getSimpleName())
                .build();
        new Runner(opt).run();
    }
}

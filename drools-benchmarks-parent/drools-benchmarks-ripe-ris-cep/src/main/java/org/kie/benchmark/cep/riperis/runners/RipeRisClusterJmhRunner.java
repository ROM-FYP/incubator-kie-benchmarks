...
/**
 * JMH runner for the RIPE RIS CEP proposed 3-cluster parallel architecture.
 */
...
public class RipeRisClusterJmhRunner {
    ...
    public void setupTrial() throws Exception {
        ...
        // Initialize orchestrator once per Trial (compiles rules once)
    ...
    public void teardownInvocation() {
        ...
        System.out.printf("[Cluster Invocation %d] Rules fired: %,d | Duration: %d ms | Throughput: %.2f events/sec | Peak Heap: %d MB%n",
                invocationCount, lastRulesFired, duration, throughput, peakHeapMb);
    ...
    public void teardownTrial() {
        ...
        System.out.println("\n=== Cluster Trial Summary (Measurement Iterations) ===");
        ...
        writeResultsJson("cluster", avgTime, avgThroughput, avgPeakHeap, startIndex, warmupIters);
    ...
    public static void main(String[] args) throws Exception {
        Options opt = new OptionsBuilder()
                .include(RipeRisClusterJmhRunner.class.getSimpleName())
                .build();
        new Runner(opt).run();
    }
}
